...
function Register() {
  ...
  const handleSubmit = async (event) => {
    ...
    if (result.success) {
      setSuccessMessage(
        result.message ||
          'Your account has been created successfully. You can sign in once your account is active.'
      );
          ...
          <section className="relative hidden lg:flex bg-gradient-to-br from-slate-950/95 via-[#5a2a12]/90 to-orange-600/90 text-white p-8 flex-col justify-between overflow-hidden">
            ...
            <div className="relative max-w-lg">
              ...
              <p className="text-white/75 leading-7 text-base max-w-md">
                Build playlists, follow artists, share tracks, and discover new
                music from the SoundWave community.
              </p>

              <div className="grid grid-cols-3 gap-3 mt-8 max-w-md">
                <div className="rounded-2xl bg-white/10 backdrop-blur p-4">
                  <p className="text-xl font-black">♫</p>
                  <p className="text-xs text-white/60 mt-2">Tracks</p>
                </div>
                ...
                <div className="rounded-2xl bg-white/10 backdrop-blur p-4">
                  <p className="text-xl font-black">♥</p>
                  <p className="text-xs text-white/60 mt-2">Playlists</p>
                </div>
              </div>
            </div>

            <div className="relative text-sm text-white/60">
              Made for listeners and artists.
            </div>
          </section>
            ...
            <div className="w-full max-w-md mx-auto">
              ...
              <div className="mb-7">
                ...
                <p className="text-slate-500 leading-7 text-base">
                  Choose your account type and set up your SoundWave profile.
                </p>
              </div>

              {successMessage && (
                <div className="mb-5 rounded-2xl bg-green-100 border border-green-200 text-green-700 px-4 py-3 text-sm">
                  <p className="font-semibold">{successMessage}</p>

                  <div className="mt-3">
                    <Link
                      to="/login"
                      className="inline-block px-4 py-2 rounded-full bg-slate-950 text-white hover:bg-slate-800 font-bold text-sm"
                    >
                      Go to Sign In
                    </Link>
                  </div>
